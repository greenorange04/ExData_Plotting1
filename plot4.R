library(dplyr)
# read the lines that should contain the necessary days (according to a 
# quick estimate)
...
box()
#plot 2
plot(dataset$Voltage, type ="l", axes = FALSE, xlab = "datetime", 
     ylab = "Voltage")
axis(1, at = c(1, lab2.pos, lab3.pos), x.labels)
axis(2)
box()
...
#plot 4
plot(dataset$Global_reactive_power, type ="l", axes = FALSE, xlab = "datetime", 
